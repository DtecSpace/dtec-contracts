...
contract StrategicSaleLock is LinearLock {
    /// @notice Constructor for StrategicSaleLock, initializing the lock with specific release timing and rate
    /// @param _dtecAddress Address of the DTEC token to be locked
    constructor(address _dtecAddress) LinearLock(_dtecAddress) {
        // TGE is 01.04.2024, first lock release for Strategic Sale is 01.06.2024
        // To get tokens on time, release lockTimestamp is 1714608001, 30 days before 01.06.2024
        setReleaseInfo(1714608001, 834);
    }
}