...
/// @title PrivateSaleLock2
/// @dev Extends LinearLock with specific settings for a private sale lock.
/// @notice Locks tokens for the private sale phase and releases them linearly starting from a specific date.
contract PrivateSaleLock2 is LinearLock {
    /// @notice Constructor for PrivateSaleLock, initializing the lock with specific release timing and rate
