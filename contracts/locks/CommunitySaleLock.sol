...
contract CommunitySaleLock is LinearLock {
    /// @notice Constructor for CommunitySaleLock, initializing the lock with specific release timing and rate
    /// @param _dtecAddress Address of the DTEC token to be locked
    constructor(address _dtecAddress) LinearLock(_dtecAddress) {
        // TGE is 07.05.2024, first lock release for PreSale is 07.10.2024
        // To get tokens on time, release lockTimestamp is 1725667200, 30 days before 07.10.2024
        setReleaseInfo(1725667200, 834);
    }
}
