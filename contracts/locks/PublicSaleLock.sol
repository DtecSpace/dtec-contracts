...
/// @title PublicSaleLock
/// @dev Extends LinearLock with specific settings for a public sale lock.
/// @notice Locks tokens for the public sale phase and releases them linearly starting from a specific date.
contract PublicSaleLock is LinearLock {
    /// @notice Constructor for PublicSaleLock, initializing the lock with specific release timing and rate
    ...
    constructor(address _dtecAddress) LinearLock(_dtecAddress) {
        ...
        setReleaseInfo(1714608001, 1250);
    }
}
