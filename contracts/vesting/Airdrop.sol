...
/// @title Airdrop
/// @dev Extends the Vesting contract with specific settings for Airdrop vesting.
/// @notice Manages the vesting of tokens specifically allocated to the Airdrop, with a distinct vesting schedule.
