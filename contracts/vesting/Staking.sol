...
/// @title Staking
/// @dev Extends the Vesting contract with specific settings for Staking vesting.
/// @notice Manages the vesting of tokens specifically allocated to the Staking, with a distinct vesting schedule.
contract Staking is Vesting {
    /// @notice Constructor for Staking Vesting, initializing the vesting with specific timing and rate for the Staking's tokens
